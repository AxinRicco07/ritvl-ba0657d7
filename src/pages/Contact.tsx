  ...
  return (
    <div className="py-12 px-4 md:py-16 bg-blue-50/50">
      <div className="container max-w-7xl mx-auto">
        <h1 className="text-3xl font-display text-center mb-6 font-bold text-blue-800">Contact Us</h1>
          ...
          <div className="flex flex-col space-y-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <div className="flex space-x-4">
                <a href="#" className="p-2 bg-blue-100 rounded-full hover:bg-blue-200 transition-colors">
