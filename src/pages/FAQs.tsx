          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-muted-foreground">
                Epsom salt is magnesium sulfate. A warm bath with Epsom salt is commonly used to relax muscles and
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                We prioritize clean, simple formulas featuring premium Epsom salt and thoughtfully selected essential oils
